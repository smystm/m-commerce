        ...
        >
          {(data).map((sld, index) => (
            <SwiperSlide className='overflow-hidden rounded-xl md:rounded-none' key={index}>
              <div style={{ backgroundImage: `url(${sld.image_url})` }} className={`w-full h-[250px] md:h-[330px] lg:h-[60vh] xl:h-[70vh] rounded-xs md:rounded-none flex flex-col justify-center items-start text-white bg-cover bg-center bg-no-repeat bg-gradient-to-r from-[#ffffff09] to-[#00000077]`}>
