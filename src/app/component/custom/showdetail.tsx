          ...
          <Tab>
            <ul className={`mx-auto w-full h-100 border-t-2 border-black/10 dark:border-white/5 flex gap-x-8 py-3 text-gray-700 dark:text-gray-300 ${selectedTab === "yes" ? "h-350 md:h-180  lg:h-150": selectedTab === "no" ? "h-280 md:h-200 lg:h-180" : "h-50"}`}>
              ...
              <li className='details-products'>
                ...
                <TabLable id="no" txtSpan="مشخصات محصول">
              ...
              <li className='details-chat'>
                ...
                <TabLable id="yesno" txtSpan="نظرات کاربران">
                  
                </TabLable>
                <Tabox className="w-full max-w-[1180px]">
                  ناموسا نظر رو بخیال کونم پاره میشه
                </Tabox>
              </li>
            </ul>
          </Tab>
...
function DetailsPara({detailtxt}:{detailtxt: string}){
  return(
    <p className='font-medium leading-10 text-lg text-gray-700 dark:text-gray-300'>
      {detailtxt}
    </p>
  )
}
